...
export function generatepdf(data) {
    ...
    // 2. Render Parameter Summary Block
    doc.setFont("helvetica", "bold");
    doc.setFontSize(11);
    doc.setTextColor(33, 37, 41);
    ...
    // 3. Setup Dynamic Grid Layout Headers
    const headers = [
        isYearly ? 'Year' : 'Month', 
        'Investment Value', 
    ...
    // 4. Calculate Accumulations and Render Grid Rows
    ...
    investmentRows.forEach((rowItem) => {
        ...
        // FIXED: Dynamically map steps and labels based on view mode keys
    ...
    // 5. Fire system print download dialogue
